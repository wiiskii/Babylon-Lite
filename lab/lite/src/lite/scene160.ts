...
@fragment fn mainFragment(input:VertexOutput)->@location(0) vec4<f32>{return textureSample(textureSampler,textureSamplerSampler,input.uv);}`;
...
async function main(): Promise<void> {
    ...
    setShaderTexture(material, "textureSampler", await loadTexture2D(engine, "/textures/nme/ebf71b300f43563f.png", { mipMaps: false, minFilter: "nearest", magFilter: "nearest" }));
