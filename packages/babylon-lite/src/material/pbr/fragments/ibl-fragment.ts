...
let environmentIrradiance = (scene.vSphericalL00
  ...
  + scene.vSphericalL22 * (N_env.x * N_env.x - N_env.y * N_env.y)) * mesh.environmentIntensity;
...
var environmentRadiance = textureSampleLevel(iblTexture, iblSampler, R, clamp(specLod, 0.0, maxLod)).rgb * mesh.environmentIntensity;
