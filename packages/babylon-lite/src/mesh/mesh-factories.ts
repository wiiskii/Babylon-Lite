...
function createMeshFromData(device: GPUDevice, name: string, positions: Float32Array, normals: Float32Array, indices: Uint32Array, uvs?: Float32Array): Mesh {
    let minX = Infinity,
        minY = Infinity,
        minZ = Infinity;
    let maxX = -Infinity,
    ...
    const mesh = {
        ...
        _gpu: uploadMeshToGPU(device, positions, normals, indices, uvs),
