/**
 * Scene 60 — NME Flat Colour Parity Test
 *
...
const REFERENCE_DIR = path.resolve(__dirname, "../../../reference/scene60-nme-flat");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 60 skipped via skipParity in scene-config.json");

test("Scene 60 — NME flat colour matches Babylon.js reference", async ({ page }, testInfo) => {
